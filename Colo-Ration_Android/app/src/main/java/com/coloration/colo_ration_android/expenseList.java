...
public class expenseList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent i = getIntent();
        table = i.getStringArrayExtra("tableExpense");
        ...
        try{
            ...
            rowTitle.setBackgroundColor(getResources().getColor(R.color.orange));
            ...
            for (int j = 0; j < table.length; j++) {
                ...
                if (j % 2 == 1) {
                    newRow.setBackgroundColor(getResources().getColor(R.color.orange));
                }
    ...
    public void addElement(){
        Intent intent = new Intent(expenseList.this, expenseForm.class);
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        ...
        if (keyCode == KeyEvent.KEYCODE_BACK) {
            Intent intent = new Intent(expenseList.this, mainColoration.class);
            startActivity(intent);
        }
